...
export function NotFound() {
	return (
		<div className="flex h-screen w-screen flex-col items-center justify-center gap-8 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 p-8 text-center dark:from-gray-900 dark:to-gray-800">
